...
pub struct AssetList
{
    ...
    #[asset(path = "objects/barrel.glb#Scene0")] pub barrel: Handle<Scene>,
    #[asset(path = "objects/burger.glb#Scene0")] pub burger: Handle<Scene>,
    #[asset(path = "objects/gun.glb#Scene0")] pub gun: Handle<Scene>,
    #[asset(path = "objects/pill.glb#Scene0")] pub pill: Handle<Scene>,
...
#[derive(Default, Resource)] pub struct StatusEffects(pub HashMap<StatusEffect, i32>);
#[derive(Default, Resource)] pub struct NewsFeed(pub VecDeque<RichText>);
...
impl Display for Money { fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result { write!(f, "${}", self.0) } }
impl AddAssign<Money> for Money { fn add_assign(&mut self, rhs: Money) { self.0 += rhs.0; } }
impl SubAssign<Money> for Money { fn sub_assign(&mut self, rhs: Money) { self.0 -= rhs.0; } }
